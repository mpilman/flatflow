...
void CodeGenerator::emit(Streams& out, expression::StructOrTable const& st) const {
	std::string typeStr =
	    st.typeType() == expression::TypeType::Struct ? "flowflat::Type::Struct" : "flowflat::Type::Table";
	Defer defer;
